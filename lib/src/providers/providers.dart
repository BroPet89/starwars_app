...
import 'package:starwars_app/features/flexitarian/presentation/pages/state/provider/flexi_recipes_notifier.dart';
import 'package:starwars_app/features/flexitarian/presentation/pages/state/provider/flexi_recipes_state.dart';
import 'package:starwars_app/src/data/repositories/recipe_repository.dart';
import 'package:starwars_app/src/domain/models/recipe.dart';
import 'package:starwars_app/src/network/api_client.dart';
import 'package:starwars_app/features/favorite/data/datasources/favorite_remote_data_source.dart';
import 'package:starwars_app/features/favorite/data/repositories/favorite_repository.dart';
import 'package:starwars_app/features/favorite/presentation/state/favorite_list_notifier.dart';
import 'package:starwars_app/features/favorite/presentation/state/favorite_list_state.dart';
import 'package:starwars_app/features/favorite/presentation/state/favorite_notifier.dart';
import 'package:starwars_app/features/favorite/presentation/state/favorite_state.dart';
import 'package:starwars_app/features/vegan/presentation/state/provider/vegan_recipes_notifier.dart';
import 'package:starwars_app/features/vegan/presentation/state/provider/vegan_recipes_state.dart';
